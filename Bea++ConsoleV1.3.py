...
while True:
    ...
    if a == "text()":
        ...
        wm1 = input("Линия из земли как будет выглядить какой символ - ")
        time.sleep(1)
        wm2 = input("Как будет выглядить дерево - ")
        if wm1 == wm1 and wm2 == wm2:
